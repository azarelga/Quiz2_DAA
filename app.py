...
# 2. Custom CSS for Font
st.markdown(
    """
<style>
@import url('https://fonts.googleapis.com/css2?family=Roboto:wght@400;700&display=swap');

html, body, [class*="st-"], [class*="Widget"] {
...
with col1:
    ...
    if st.button("Add Task", key="add_task_button"):
        ...
        if task_name_to_add:  # Check if the string is not empty
            ...
            st.session_state.clear_new_task_input = (
    ...
    if st.button("Add Dependency", key="add_dependency_button"):
        ...
        if prereq_task and depend_task:
            ...
            st.warning(
                "Both prerequisite and dependent task names are required.")
...
with col2:
    ...
    st.subheader("Execution Order")  # Or "View Execution Order"
